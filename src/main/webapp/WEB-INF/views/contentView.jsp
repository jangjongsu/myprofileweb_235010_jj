							...
							<center>
								<table  border="0" cellspacing="0" cellpadding="10">
									...
									<tr>
										...
										<td><textarea rows="8" cols="35" name="bcontent" class="textareabox" readonly="readonly">${boardDto.bcontent}</textarea></td>
									</tr>
									<tr>
									...
									<tr>
										<td class= "contenttext">등 록 일 : </td>
										<td><input class="inputbox01" type="text" name="bdate" value="${boardDto.bdate }" readonly="readonly"></td>
									</tr>
									<tr>
										<td colspan="2" align="center">
											<input class="contentbtn01" type="button" value="삭제" onclick="script:window.location.href='delete?bnum=${boardDto.bnum }'">&nbsp;
